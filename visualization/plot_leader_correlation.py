...
def main() -> None:
    ...
    if has_leader and leader_id >= 0:
        ...
        axes[0].set_title(f"Collective Mean Orientation | run={run_dir.name}, scenario={scenario}, eta={eta}")
        ...
        ax.set_title(f"Collective Mean Orientation (no leader) | run={run_dir.name}, scenario={scenario}, eta={eta}")
        ax.grid(alpha=0.25)
        ax.legend(loc="best")
